      ...
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-2">
        <div className="flex items-center justify-between p-4 border rounded-lg shadow-sm bg-white">
          ...
          <div className="flex sm:flex-row flex-col sm:space-x-2 sm:space-y-0 space-y-1">
            <Button variant="outline" size="sm" className=" cursor-pointer hover:bg-gray-100">
              <PencilIcon className="w-4 h-4 mr-1" /> Edit
            </Button>
            <Button variant="default" size="sm" className="bg-red-600 text-white hover:bg-red-600/70 cursor-pointer">
